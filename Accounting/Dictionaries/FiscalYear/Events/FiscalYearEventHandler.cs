...
public partial class FiscalYearEventHandler : TypedDictionaryEventHandler<FiscalYear>
{
    ...
    public override async Task<EventResult> OnBeforeCreateAsync(FiscalYear record, EventContext context){
    ...
    public override async Task<EventResult> OnBeforeSaveAsync(FiscalYear record, bool isNew, EventContext context){
