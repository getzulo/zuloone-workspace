...
public partial class HRSettingsEventHandler : TypedDictionaryEventHandler<HRSettings>
{
    ...
    public override Task<EventResult> OnBeforeCreateAsync(HRSettings record, EventContext context)
    {
    ...
    public override Task<EventResult> OnBeforeSaveAsync(HRSettings record, bool isNew, EventContext context)
    {
