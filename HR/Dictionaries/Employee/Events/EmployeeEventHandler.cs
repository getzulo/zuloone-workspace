...
public partial class EmployeeEventHandler : TypedDictionaryEventHandler<Employee>
{
    ...
    public override Task<EventResult> OnBeforeCreateAsync(Employee record, EventContext context)
    {
    ...
    public override Task<EventResult> OnBeforeSaveAsync(Employee record, bool isNew, EventContext context)
    {
