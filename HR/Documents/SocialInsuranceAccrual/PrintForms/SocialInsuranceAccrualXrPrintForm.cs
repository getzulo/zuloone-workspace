...
// Social insurance accrual: employee, base, employee/employer shares. Not sales pricing.
public partial class SocialInsuranceAccrualXrPrintForm : PrintFormBase
{
    ...
    public override async Task<SlimTable> GetDataAsync(PrintFormContext context)
    {
        ...
        var doc = await documents.GetDocumentAsync<SocialInsuranceAccrual>(context.RecordId);
        if (doc == null)
        {
        ...
        foreach (var line in doc.Lines)
        {
            ...
            table.Add(Row(
                ...
                employeeTotal, employerTotal, total, n, "", line.ContributoryBase, "",
