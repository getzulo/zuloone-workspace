public partial class SalesLeadTransactionsScript
{
    protected override void GetTransactions(SalesLead document, TransactionPairCollection transactionPairs, TransactionCollection transactions)
    {
