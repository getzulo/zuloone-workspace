...
// Loyalty redemption slip: customer and points from the header. Not a sales invoice.
public partial class LoyaltyRedemptionXrPrintForm : PrintFormBase
{
    ...
    public override async Task<SlimTable> GetDataAsync(PrintFormContext context)
    {
        ...
        var doc = await documents.GetDocumentAsync<LoyaltyRedemption>(context.RecordId);
        if (doc == null)
        {
