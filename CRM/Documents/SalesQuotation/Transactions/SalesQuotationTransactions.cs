public partial class SalesQuotationTransactionsScript
{
    protected override void GetTransactions(SalesQuotation document, TransactionPairCollection transactionPairs, TransactionCollection transactions)
    {
