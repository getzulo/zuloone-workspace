...
// Quantity-only put-away list: receiving cell → storage cell. No money on this page.
public partial class PutAwayTaskXrPrintForm : PrintFormBase
{
    ...
    public override async Task<SlimTable> GetDataAsync(PrintFormContext context)
    {
        ...
        var doc = await documents.GetDocumentAsync<PutAwayTask>(context.RecordId);
        if (doc == null)
        {
