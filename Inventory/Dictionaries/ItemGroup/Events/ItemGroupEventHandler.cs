...
public partial class ItemGroupEventHandler : TypedDictionaryEventHandler<ItemGroup>
{
    ...
    public override Task<EventResult> OnBeforeCreateAsync(ItemGroup record, EventContext context)
    {
    ...
    public override Task<EventResult> OnBeforeSaveAsync(ItemGroup record, bool isNew, EventContext context)
    {
