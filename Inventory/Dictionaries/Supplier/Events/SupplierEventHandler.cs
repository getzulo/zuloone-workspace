...
public partial class SupplierEventHandler : TypedDictionaryEventHandler<Supplier>
{
    ...
    public override Task<EventResult> OnBeforeCreateAsync(Supplier record, EventContext context)
    {
    ...
    public override Task<EventResult> OnBeforeSaveAsync(Supplier record, bool isNew, EventContext context)
    {
