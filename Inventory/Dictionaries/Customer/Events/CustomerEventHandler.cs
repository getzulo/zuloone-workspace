...
public partial class CustomerEventHandler : TypedDictionaryEventHandler<Customer>
{
    ...
    public override Task<EventResult> OnBeforeCreateAsync(Customer record, EventContext context)
    {
    ...
    public override Task<EventResult> OnBeforeSaveAsync(Customer record, bool isNew, EventContext context)
    {
