...
public partial class ItemEventHandler : TypedDictionaryEventHandler<Item>
{
    ...
    public override Task<EventResult> OnBeforeCreateAsync(Item record, EventContext context)
    {
    ...
    public override Task<EventResult> OnBeforeSaveAsync(Item record, bool isNew, EventContext context)
    {
