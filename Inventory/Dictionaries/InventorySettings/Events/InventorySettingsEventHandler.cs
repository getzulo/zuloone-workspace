...
// `record` is a typed InventorySettings entity — access fields directly (record.SomeField).
...
public partial class InventorySettingsEventHandler : TypedDictionaryEventHandler<InventorySettings>
{
    ...
    //public override Task<EventResult> OnBeforeInsertAsync(InventorySettings record, EventContext context)
    //    => Task.FromResult(EventResult.Ok());
    //public override Task<EventResult> OnAfterInsertAsync(InventorySettings record, EventContext context)
    //    => Task.FromResult(EventResult.Ok());
    //public override Task<EventResult> OnBeforeUpdateAsync(InventorySettings record, EventContext context)
    //    => Task.FromResult(EventResult.Ok());
    //public override Task<EventResult> OnAfterUpdateAsync(InventorySettings record, EventContext context)
    //    => Task.FromResult(EventResult.Ok());
