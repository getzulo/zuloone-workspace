...
public class UkraineDpsPayrollFilingTest : IntegrationTestScriptBase
{
    ...
    public async Task D1InsuredPerson()
    {
        ...
        Assert.IsTrue(text.Contains("1;;3123456789;1;1;3;2026;Петренко;;;0;0;31;0;10000.00;10000.00;0.00;2200.00;1;0;0;0"),
            "рядок Д1. Факт:\n{0}", text);
        Assert.IsTrue(text.Contains("T1RXXXXG5") && text.Contains("T1RXXXXG6S") && text.Contains("T1RXXXXG24"),
            "G5 громадянство, G6S стать і G24 нове місце в шапці. Факт:\n{0}", text);
    ...
    public async Task D1DaysFollowHireDate()
    {
        ...
        var text = await PayloadAsync(env.Entity, "J0510111");
        Assert.IsTrue(text.Contains("1;;3123456789;1;1;3;2026;Петренко;;;0;0;20;0;10000.00;10000.00;0.00;2200.00;1;0;0;0"),
            "G14 = дні від найму, не довжина місяця. G24 лишається 0: прийом ≠ нове місце. Факт:\n{0}", text);
    ...
    public async Task D1DaysFollowFireDate()
    {
        ...
        var text = await PayloadAsync(env.Entity, "J0510111");
        Assert.IsTrue(text.Contains("1;;3123456789;1;1;3;2026;Петренко;;;0;0;10;0;10000.00;10000.00;0.00;2200.00;1;0;0;0"),
    ...
    public async Task D1AccruedStaysAfterEsvPayment()
    {
        ...
        Assert.IsTrue(d1.Contains("1;;3123456789;1;1;3;2026;Петренко;;;0;0;31;0;10000.00;10000.00;0.00;2200.00;1;0;0;0"),
    ...
    public async Task D1SickDaysFromTimeOff()
    {
        ...
        Assert.IsTrue(text.Contains("1;;3123456789;1;1;3;2026;Петренко;;;5;0;31;0;10000.00;10000.00;0.00;2200.00;1;0;0;0"),
    ...
    public async Task D1MaternityDaysFromTimeOff()
    {
        ...
        var text = await PayloadAsync(env.Entity, "J0510111");
        Assert.IsTrue(text.Contains("1;;3123456789;1;1;3;2026;Петренко;;;0;0;31;5;10000.00;10000.00;0.00;2200.00;1;0;0;0"),
    ...
    public async Task D1MainWorkplaceFromPartTime()
    {
        ...
        var text = await PayloadAsync(env.Entity, "J0510111");
        Assert.IsTrue(text.Contains("1;;3123456789;1;1;3;2026;Петренко;;;0;0;31;0;10000.00;10000.00;0.00;2200.00;0;0;0;0"),
    ...
    public async Task D1UnpaidLeaveDaysFromTimeOff()
    {
        ...
        Assert.IsTrue(text.Contains("1;;3123456789;1;1;3;2026;Петренко;;;0;5;31;0;10000.00;10000.00;0.00;2200.00;1;0;0;0"),
    ...
    public async Task D1PartTimeHoursFlag()
    {
        ...
        Assert.IsTrue(text.Contains("1;;3123456789;1;1;3;2026;Петренко;;;0;0;31;0;10000.00;10000.00;0.00;2200.00;1;1;0;0"),
    ...
    [IntegrationTest("Д1 J0510111: стать Ч з картки, латиниця M не мапиться")]
    public async Task D1SexFromEmployee()
    {
        var env = await SetupAsync();
        await ConfigureHrAsync();
        await ConfigureUaAsync();
        ...
        var text = await PayloadAsync(env.Entity, "J0510111");
        Assert.IsTrue(text.Contains("1;Ч;3123456789;1;1;3;2026;Петренко;;;0;0;31;0;10000.00"),
            "G6S=Ч з поля, нижній регістр нормалізується. Факт:\n{0}", text);
        ...
        var returnId2 = await Returns.BuildAsync(env.Entity, new DateTime(2026, 3, 1), new DateTime(2026, 3, 31));
        await Filing.ExportDpsPayrollAsync(returnId2);
        var again = await PayloadAsync(env.Entity, "J0510111");
        Assert.IsTrue(again.Contains("1;;3123456789;1;1;3;2026;Петренко;;;0;0;31;0;10000.00"),
            "латиниця M не стать ДПС. Факт:\n{0}", again);
        Assert.IsTrue(!again.Contains("1;M;3123456789"),
            "M не потрапляє в G6S. Факт:\n{0}", again);
    }

    [IntegrationTest("Д1 J0510111: нове робоче місце G24=1 з прапорця, не з HireDate")]
    public async Task D1NewWorkplaceFromEmployee()
    {
        var env = await SetupAsync();
        await ConfigureHrAsync();
        await ConfigureUaAsync();
        await PatchEmployeeAsync(env, hire: new DateTime(2026, 3, 12), newWorkplace: true);
        await AccrueAsync(env.Division, env.Employee, 10000m, new DateTime(2026, 3, 15));
        ...
        var text = await PayloadAsync(env.Entity, "J0510111");
        Assert.IsTrue(text.Contains("T1RXXXXG24"), "графа G24 в шапці CSV. Факт:\n{0}", text);
        Assert.IsTrue(text.Contains("1;;3123456789;1;1;3;2026;Петренко;;;0;0;20;0;10000.00;10000.00;0.00;2200.00;1;0;0;1"),
            "G24=1 з прапорця, G14=20 від найму. Факт:\n{0}", text);
    }
    ...
    public async Task D5LeaveAndD6Tenure()
    {
        ...
        var d1 = await PayloadAsync(env.Entity, "J0510111");
        Assert.IsTrue(d1.Contains("2200.00;1;0;1;0"), "Д1 G23 спецстаж. Факт:\n{0}", d1);
        ...
        bool newWorkplace = false)
    {
        ...
        if (newWorkplace) bag["DpsNewWorkplace"] = true;
        var employee = (await Dict.GetRecordsAsync<Employee>($"Division = '{env.Division}'"))
            .FirstOrDefault(e => e.MetaId == env.Employee);
        if (employee != null)
        {
