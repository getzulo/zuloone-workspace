...
{
    public override async Task<EventResult> OnBeforeCreateAsync(UaSingleTaxLimit record, EventContext context)
    {
        ...
        var createSeed = await createDefaults.SeedAsync("UaSingleTaxLimit");
