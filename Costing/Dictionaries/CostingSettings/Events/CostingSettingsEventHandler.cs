...
public partial class CostingSettingsEventHandler : TypedDictionaryEventHandler<CostingSettings>
{
    ...
    public override Task<EventResult> OnBeforeCreateAsync(CostingSettings record, EventContext context)
    {
    ...
    public override Task<EventResult> OnBeforeSaveAsync(CostingSettings record, bool isNew, EventContext context)
    {
