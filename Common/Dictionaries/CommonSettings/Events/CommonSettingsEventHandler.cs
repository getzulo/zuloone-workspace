...
public partial class CommonSettingsEventHandler : TypedDictionaryEventHandler<CommonSettings>
{
    ...
    public override Task<EventResult> OnBeforeCreateAsync(CommonSettings record, EventContext context)
    {
    ...
    public override Task<EventResult> OnBeforeSaveAsync(CommonSettings record, bool isNew, EventContext context)
    {
