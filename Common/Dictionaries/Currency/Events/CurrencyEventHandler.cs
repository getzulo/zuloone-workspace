...
public partial class CurrencyEventHandler : TypedDictionaryEventHandler<Currency>
{
    ...
    public override Task<EventResult> OnBeforeCreateAsync(Currency record, EventContext context)
    {
    ...
    public override Task<EventResult> OnBeforeSaveAsync(Currency record, bool isNew, EventContext context)
    {
