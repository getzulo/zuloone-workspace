...
public partial class GenderEventHandler : TypedDictionaryEventHandler<Gender>
{
    ...
    public override Task<EventResult> OnBeforeCreateAsync(Gender record, EventContext context)
    {
    ...
    public override Task<EventResult> OnBeforeSaveAsync(Gender record, bool isNew, EventContext context)
    {
