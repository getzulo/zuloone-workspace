...
public partial class UnitClassEventHandler : TypedDictionaryEventHandler<UnitClass>
{
    ...
    public override async Task<EventResult> OnBeforeCreateAsync(UnitClass record, EventContext context){
    ...
    public override async Task<EventResult> OnBeforeSaveAsync(UnitClass record, bool isNew, EventContext context){
