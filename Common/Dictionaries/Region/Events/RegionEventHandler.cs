...
public partial class RegionEventHandler : TypedDictionaryEventHandler<Region>
{
    ...
    public override Task<EventResult> OnBeforeCreateAsync(Region record, EventContext context)
    {
    ...
    public override Task<EventResult> OnBeforeSaveAsync(Region record, bool isNew, EventContext context)
    {
