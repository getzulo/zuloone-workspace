...
public partial class AddressEventHandler : TypedDictionaryEventHandler<Address>
{
    ...
    public override Task<EventResult> OnBeforeCreateAsync(Address record, EventContext context)
    {
    ...
    public override Task<EventResult> OnBeforeSaveAsync(Address record, bool isNew, EventContext context)
    {
