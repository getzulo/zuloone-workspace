...
public partial class CityEventHandler : TypedDictionaryEventHandler<City>
{
    ...
    public override Task<EventResult> OnBeforeCreateAsync(City record, EventContext context)
    {
    ...
    public override Task<EventResult> OnBeforeSaveAsync(City record, bool isNew, EventContext context)
    {
