...
public partial class LocalizationSaudiArabiaSettingsEventHandler : TypedDictionaryEventHandler<LocalizationSaudiArabiaSettings>
{
    ...
    public override async Task<EventResult> OnBeforeCreateAsync(LocalizationSaudiArabiaSettings record, EventContext context){
    ...
    public override async Task<EventResult> OnBeforeSaveAsync(LocalizationSaudiArabiaSettings record, bool isNew, EventContext context){
