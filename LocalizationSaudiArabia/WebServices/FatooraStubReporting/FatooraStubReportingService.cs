...
// Stand stub for Fatoora — B2C reporting.
//
...
public partial class FatooraStubReportingService
{
    public override async Task<object?> Any(FatooraStubReportingRequest request)
    {
        ...
        if (seen.Count > 0)
        {
            return new FatooraStubReportingResponse
            {
                Ok = true,
