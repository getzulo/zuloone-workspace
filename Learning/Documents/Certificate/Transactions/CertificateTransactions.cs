public partial class CertificateTransactionsScript
{
    protected override void GetTransactions(Certificate document, TransactionPairCollection transactionPairs, TransactionCollection transactions)
    {
