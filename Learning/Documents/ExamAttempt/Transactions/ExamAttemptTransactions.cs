public partial class ExamAttemptTransactionsScript
{
    protected override void GetTransactions(ExamAttempt document, TransactionPairCollection transactionPairs, TransactionCollection transactions)
    {
