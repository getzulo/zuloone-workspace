...
public class ProductionFlowTest : IntegrationTestScriptBase
{
    ...
    public async Task FinishConsumesAndProduces()
    {
        ...
        // Состояние ДО перехода: черновик не двигает Stock (резерв — другой
        // регистр) — компонент ещё 20, изделия ещё нет. Без этого утверждения
        // проверки после перехода проходят и тогда, когда заказ разнёсся сам
        // при сохранении.
