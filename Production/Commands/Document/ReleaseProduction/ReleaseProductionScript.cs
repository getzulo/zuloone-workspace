...
// Draft → Released: components leave the cell, the finished good is not
// there yet. FinishProduction then recalculates consume + output (Mix).
public partial class ReleaseProductionCommand
{
