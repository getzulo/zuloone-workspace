...
// `record` is a typed OrganizationSettings entity — access fields directly (record.SomeField).
...
public partial class OrganizationSettingsEventHandler : TypedDictionaryEventHandler<OrganizationSettings>
{
    // Building a new record server-side: seed default field values here.
    public override async Task<EventResult> OnBeforeCreateAsync(OrganizationSettings record, EventContext context){
    ...
    public override async Task<EventResult> OnBeforeSaveAsync(OrganizationSettings record, bool isNew, EventContext context){
    ...
    public override Task<EventResult> OnAfterSaveAsync(OrganizationSettings record, bool isNew, EventContext context)
    ...
    //public override Task<EventResult> OnBeforeInsertAsync(OrganizationSettings record, EventContext context)
    //    => Task.FromResult(EventResult.Ok());
    //public override Task<EventResult> OnAfterInsertAsync(OrganizationSettings record, EventContext context)
    //    => Task.FromResult(EventResult.Ok());
    //public override Task<EventResult> OnBeforeUpdateAsync(OrganizationSettings record, EventContext context)
    //    => Task.FromResult(EventResult.Ok());
    //public override Task<EventResult> OnAfterUpdateAsync(OrganizationSettings record, EventContext context)
    //    => Task.FromResult(EventResult.Ok());
    ...
    public override Task<EventResult> OnBeforeCloneAsync(OrganizationSettings record, EventContext context)
        => next(record, context);
    ...
    public override Task<EventResult> OnSaveFailedAsync(OrganizationSettings record, string errorMessage, EventContext context)
