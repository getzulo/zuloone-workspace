...
public partial class OrganizationSettingsEventHandler : TypedDictionaryEventHandler<OrganizationSettings>
{
    ...
    public override Task<EventResult> OnBeforeCreateAsync(OrganizationSettings record, EventContext context)
    {
    ...
    public override Task<EventResult> OnBeforeSaveAsync(OrganizationSettings record, bool isNew, EventContext context)
    {
