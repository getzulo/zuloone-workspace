...
// Handler for table-part SalesInvoiceLines (row class SalesInvoiceLinesTablePartRow).
...
{
    // public override async Task<EventResult> OnFieldChangedAsync(SalesInvoiceLinesTablePartRow row, string fieldName, object? value, EventContext context)
    // {
