...
// Handler for table-part SalesOrderLines (row class SalesOrderLinesTablePartRow).
...
{
    // public override async Task<EventResult> OnFieldChangedAsync(SalesOrderLinesTablePartRow row, string fieldName, object? value, EventContext context)
    // {
