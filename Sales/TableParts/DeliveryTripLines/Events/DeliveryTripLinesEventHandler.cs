...
// Handler for table-part DeliveryTripLines (row class DeliveryTripLinesTablePartRow).
...
{
    // public override async Task<EventResult> OnFieldChangedAsync(DeliveryTripLinesTablePartRow row, string fieldName, object? value, EventContext context)
    // {
