public partial class AgentVisitTransactionsScript
{
    protected override void GetTransactions(AgentVisit document, TransactionPairCollection transactionPairs, TransactionCollection transactions)
    {
