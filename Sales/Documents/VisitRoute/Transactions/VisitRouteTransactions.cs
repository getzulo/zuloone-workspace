public partial class VisitRouteTransactionsScript
{
    protected override void GetTransactions(VisitRoute document, TransactionPairCollection transactionPairs, TransactionCollection transactions)
    {
