...
// `record` is a typed SalesSettings entity — access fields directly (record.SomeField).
...
public partial class SalesSettingsEventHandler : TypedDictionaryEventHandler<SalesSettings>
{
    // Building a new record server-side: seed default field values here.
    public override async Task<EventResult> OnBeforeCreateAsync(SalesSettings record, EventContext context){
    ...
    public override async Task<EventResult> OnBeforeSaveAsync(SalesSettings record, bool isNew, EventContext context){
    ...
    public override Task<EventResult> OnAfterSaveAsync(SalesSettings record, bool isNew, EventContext context)
    ...
    //public override Task<EventResult> OnBeforeInsertAsync(SalesSettings record, EventContext context)
    //    => Task.FromResult(EventResult.Ok());
    //public override Task<EventResult> OnAfterInsertAsync(SalesSettings record, EventContext context)
    //    => Task.FromResult(EventResult.Ok());
    //public override Task<EventResult> OnBeforeUpdateAsync(SalesSettings record, EventContext context)
    //    => Task.FromResult(EventResult.Ok());
    //public override Task<EventResult> OnAfterUpdateAsync(SalesSettings record, EventContext context)
    //    => Task.FromResult(EventResult.Ok());
    ...
    public override Task<EventResult> OnBeforeCloneAsync(SalesSettings record, EventContext context)
        => next(record, context);
    ...
    public override Task<EventResult> OnSaveFailedAsync(SalesSettings record, string errorMessage, EventContext context)
