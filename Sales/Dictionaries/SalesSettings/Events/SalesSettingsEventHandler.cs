...
public partial class SalesSettingsEventHandler : TypedDictionaryEventHandler<SalesSettings>
{
    ...
    public override Task<EventResult> OnBeforeCreateAsync(SalesSettings record, EventContext context)
    {
    ...
    public override Task<EventResult> OnBeforeSaveAsync(SalesSettings record, bool isNew, EventContext context)
    {
