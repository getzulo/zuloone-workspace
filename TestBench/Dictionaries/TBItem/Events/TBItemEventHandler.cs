...
public partial class TBItemEventHandler : TypedDictionaryEventHandler<TBItem>
{
    ...
    public override Task<EventResult> OnBeforeCreateAsync(TBItem record, EventContext context)
    {
    ...
    public override Task<EventResult> OnBeforeSaveAsync(TBItem record, bool isNew, EventContext context)
    {
