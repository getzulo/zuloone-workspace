...
public partial class TaxRuleEventHandler : TypedDictionaryEventHandler<TaxRule>
{
    ...
    public override Task<EventResult> OnBeforeCreateAsync(TaxRule record, EventContext context)
    {
    ...
    public override Task<EventResult> OnBeforeSaveAsync(TaxRule record, bool isNew, EventContext context)
    {
