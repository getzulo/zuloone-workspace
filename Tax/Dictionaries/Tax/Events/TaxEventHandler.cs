...
public partial class TaxEventHandler : TypedDictionaryEventHandler<Tax>
{
    ...
    public override Task<EventResult> OnBeforeCreateAsync(Tax record, EventContext context)
    {
    ...
    public override Task<EventResult> OnBeforeSaveAsync(Tax record, bool isNew, EventContext context)
    {
