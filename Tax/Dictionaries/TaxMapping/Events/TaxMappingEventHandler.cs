...
{
    public override async Task<EventResult> OnBeforeCreateAsync(TaxMapping record, EventContext context)
    {
        ...
        var createSeed = await createDefaults.SeedAsync("TaxMapping");
