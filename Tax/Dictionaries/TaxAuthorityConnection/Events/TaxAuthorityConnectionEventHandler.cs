...
public partial class TaxAuthorityConnectionEventHandler : TypedDictionaryEventHandler<TaxAuthorityConnection>
{
    ...
    public override Task<EventResult> OnBeforeCreateAsync(TaxAuthorityConnection record, EventContext context)
    {
    ...
    public override Task<EventResult> OnBeforeSaveAsync(TaxAuthorityConnection record, bool isNew, EventContext context)
    {
