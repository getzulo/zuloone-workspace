...
// Tax return paper: period, codes, amounts from the document — not sales pricing.
public partial class TaxReturnXrPrintForm : PrintFormBase
{
    ...
    public override async Task<SlimTable> GetDataAsync(PrintFormContext context)
    {
        ...
        foreach (var line in doc.Lines)
        {
            ...
            var direction = await NameAsync(display, "TaxDirection", line.Direction, ct);
            table.Add(Row(
                doc.ID ?? "",
