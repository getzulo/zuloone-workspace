public partial class TaxDocumentTransactionsScript
{
    protected override void GetTransactions(TaxDocument document, TransactionPairCollection transactionPairs, TransactionCollection transactions)
    {
